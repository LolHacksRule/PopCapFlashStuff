package com.popcap.flash.games.blitz3.ui.widgets.boosts
{
   ...
   public class §_-AK§ extends BoostButton
   {
      
      private static const §_-AQ§:Class = §_-fS§;
      
      private static const §_-En§:Class = §_-PF§;
      
      private static const §_-Tw§:Class = §_-aT§;
       
      
      public function §_-AK§(param1:§_-0Z§)
      {
         super(param1);
