package com.popcap.flash.games.blitz3.ui.widgets.boosts
{
   ...
   public class §_-SL§ extends BoostButton
   {
      
      private static const §_-AQ§:Class = §_-R3§;
      
      private static const §_-En§:Class = §_-kb§;
      
      private static const §_-Tw§:Class = §_-b§;
       
      
      public function §_-SL§(param1:§_-0Z§)
      {
         super(param1);
