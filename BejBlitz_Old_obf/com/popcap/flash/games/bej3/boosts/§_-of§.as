package com.popcap.flash.games.bej3.boosts
{
   ...
   public class §_-of§ implements IBoost
   {
      
      public static const §_-oj§:int = 3;
      
      public static const §_-Ad§:int = 1;
      
      public static const §_-aB§:String = "Detonate";
       
      
      private var mApp:§_-0Z§;
      
      public function §_-of§(param1:§_-0Z§)
      {
         super();
         this.mApp = param1;
      }
      ...
      {
         var _loc1_:Gem = this.mApp.logic.board.§_-9K§(§_-2j§.§_-dp§,§_-2j§.LEFT);
         _loc1_.§_-PT§(Gem.§_-72§,true);
