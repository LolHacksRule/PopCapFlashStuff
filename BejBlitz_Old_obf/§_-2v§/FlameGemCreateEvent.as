package §_-2v§
{
   ...
   public class FlameGemCreateEvent extends Event implements BlitzEvent
   {
      
      public static const §_-aB§:String = "FlameGemCreateEvent";
      ...
      public function FlameGemCreateEvent(param1:Gem, param2:Match = null)
      {
         super(§_-aB§);
         this.§_-IB§ = param1;
         this.§_-p0§ = param2;
