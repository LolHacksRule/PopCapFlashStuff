package com.popcap.flash.framework.math
{
   public class Hermite
   {
      ...
      public function Hermite()
      {
         ...
         this.mXSub = new Vector.<Number>(2,true);
         super();
         this.q = new Vector.<Vector.<Number>>(NUM_DIMS,true);
         for(var i:int = 0; i < NUM_DIMS; i++)
         {
            this.q[i] = new Vector.<Number>(NUM_DIMS,true);
         }
         this.z = new Vector.<Number>(NUM_DIMS,true);
      }
