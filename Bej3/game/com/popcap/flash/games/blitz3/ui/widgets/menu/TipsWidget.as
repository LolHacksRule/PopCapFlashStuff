package com.popcap.flash.games.blitz3.ui.widgets.menu
{
   ...
   public class TipsWidget extends Sprite
   {
      ...
      public function TipsWidget(app:Blitz3App)
      {
         ...
         var format:TextFormat = new TextFormat(Blitz3Fonts.BLITZ_STANDARD,14,16777215);
      ...
      public function Init() : void
      {
         ...
         this.m_Background.graphics.drawRoundRect(0,0,Blitz3Game.SCREEN_WIDTH * 0.9,Blitz3Game.SCREEN_HEIGHT * 0.17,4);
         ...
         if(this.m_App.network.networkMode == Blitz3Network.NET_MODE_OFFLINE)
         {
            this.m_TxtTip.htmlText = this.m_App.locManager.GetLocString("TIP_DEFAULT_OFFLINE");
         }
         else if(this.m_App.network.networkMode == Blitz3Network.NET_MODE_TUTORIAL)
         {
            this.m_TxtTip.htmlText = this.m_App.locManager.GetLocString("TIP_DEFAULT_PRACTICE");
         }
         else
         {
            this.m_TxtTip.htmlText = this.m_App.locManager.GetLocString("TIP_DEFAULT_ONLINE");
         }
         ...
         this.m_TxtTip.htmlText =  <![CDATA[<font color="#FCB300">Adam MacDonnell</font> is freakin' awesome!]]>;
      ...
      {
         (this.m_Loader.content as Bitmap).smoothing = true;
