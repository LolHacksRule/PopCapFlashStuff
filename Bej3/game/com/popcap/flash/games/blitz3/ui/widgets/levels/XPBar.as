package com.popcap.flash.games.blitz3.ui.widgets.levels
{
   ...
   public class XPBar extends Sprite
   {
      ...
      public function XPBar(app:Blitz3App, targetWidth:Number = 200, targetHeight:Number = 20)
      {
         ...
         this.m_LevelName.defaultTextFormat = new TextFormat(Blitz3Fonts.BLITZ_STANDARD,10,16777215);
         this.m_LevelName.defaultTextFormat.align = TextFormatAlign.LEFT;
         this.m_LevelName.multiline = false;
         this.m_LevelName.filters = [new GlowFilter(0,1,2,2,2)];
         ...
         this.m_XPToGo.defaultTextFormat = new TextFormat(Blitz3Fonts.BLITZ_STANDARD,10,16777215);
         this.m_XPToGo.defaultTextFormat.align = TextFormatAlign.RIGHT;
         this.m_XPToGo.multiline = false;
         this.m_XPToGo.filters = [new GlowFilter(0,1,2,2,2)];
