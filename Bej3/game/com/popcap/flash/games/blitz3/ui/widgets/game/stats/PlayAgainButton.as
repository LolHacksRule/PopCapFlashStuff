package com.popcap.flash.games.blitz3.ui.widgets.game.stats
{
   ...
   public class PlayAgainButton extends FadeButton
   {
      
      [Embed(source="/../resources/images/stats/gameover_button_background.png")]
      private static const BACK:Class = PlayAgainButton_BACK;
      
      [Embed(source="/../resources/images/button_standard_down.png")]
      private static const OVER:Class = PlayAgainButton_OVER;
      
      [Embed(source="/../resources/images/button_standard_up.png")]
      private static const UP:Class = PlayAgainButton_UP;
      ...
      {
         var upSprite:Sprite = this.CreateButtonSprite(new UP(),this.m_app.locManager.GetLocString("UI_GAMESTATS_PLAY_AGAIN"));
         var overSprite:Sprite = this.CreateButtonSprite(new OVER(),this.m_app.locManager.GetLocString("UI_GAMESTATS_PLAY_AGAIN"));
         var ct:ColorTransform = new ColorTransform(0.9,0.9,0.9);
         overSprite.transform.colorTransform = ct;
         var downSprite:Sprite = this.CreateButtonSprite(new OVER(),this.m_app.locManager.GetLocString("UI_GAMESTATS_PLAY_AGAIN"));
