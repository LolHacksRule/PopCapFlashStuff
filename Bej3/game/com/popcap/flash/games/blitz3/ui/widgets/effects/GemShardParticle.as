package com.popcap.flash.games.blitz3.ui.widgets.effects
{
   ...
   public class GemShardParticle extends SpriteEffect
   {
      ...
      public function GemShardParticle(app:Blitz3App, gem:Gem)
      {
         ...
         this.mShardImg = app.imageManager.getImageInst(Blitz3Images.IMAGE_GEM_SHARDS);
         this.mCoverImg = app.imageManager.getImageInst(Blitz3Images.IMAGE_GEM_SHARDS_OUTLINE);
      ...
      override public function Update() : void
      {
         ...
         this.mCoverImg.y = y;
         ++this.mTimer;
         var progress:Number = this.mTimer / 100 * 16;
         ...
         this.mShardBitmap.x = -(this.mShardImg.width / 2);
         this.mShardBitmap.y = -(this.mShardImg.height / 2);
         this.mShardBitmap.smoothing = true;
         this.mCoverBitmap.bitmapData = this.mCoverImg.pixels;
         this.mCoverBitmap.x = -(this.mCoverImg.width / 2);
         this.mCoverBitmap.y = -(this.mCoverImg.height / 2);
         this.mCoverBitmap.smoothing = true;
