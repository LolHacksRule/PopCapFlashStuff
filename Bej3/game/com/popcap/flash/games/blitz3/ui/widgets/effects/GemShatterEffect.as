package com.popcap.flash.games.blitz3.ui.widgets.effects
{
   ...
   public class GemShatterEffect extends SpriteEffect
   {
      ...
      override public function Update() : void
      {
         ...
         this.m_ExplodeAnim.mFrame = int(this.m_Timer / 100 * 15);
         this.m_ExplodeBitmap.x = -(this.m_ExplodeAnim.width / 2);
         this.m_ExplodeBitmap.y = -(this.m_ExplodeAnim.height / 2);
         ...
         this.m_ExplodeBitmap.smoothing = true;
         ...
         if(this.m_Timer == 0)
         {
            ...
            {
               this.m_App.soundManager.playSound(Blitz3Sounds.SOUND_GEM_STAR_SHATTER);
            }
         }
         ++this.m_Timer;
      }
      ...
      private function Init() : void
      {
         ...
         this.m_ExplodeAnim = this.m_App.imageManager.getImageInst(Blitz3Images.IMAGE_GEM_EFFECT_EXPLODE);
         this.m_DistortAnim = this.m_App.imageManager.getImageInst(Blitz3Images.IMAGE_GEM_EFFECT_DISTORT);
