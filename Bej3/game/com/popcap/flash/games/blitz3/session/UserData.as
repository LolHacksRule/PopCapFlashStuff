package com.popcap.flash.games.blitz3.session
{
   ...
   public class UserData
   {
      ...
      protected var m_Coins:int = 0;
      
      protected var m_XP:Number = 0;
      
      protected var m_Level:int = 0;
      
      protected var m_PrevLevelCutoff:Number = 0;
      
      protected var m_NextLevelCutoff:Number = 0;
      
      protected var m_Handlers:Vector.<IUserDataHandler>;
      ...
      public function AddCoins(dCoins:int) : void
      {
         this.SetCoins(this.m_Coins + dCoins);
      }
