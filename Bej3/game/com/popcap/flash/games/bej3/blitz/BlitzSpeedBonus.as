package com.popcap.flash.games.bej3.blitz
{
   ...
   public class BlitzSpeedBonus
   {
      ...
      private var m_Bonus:int = 0;
      
      private var m_IdleCount:int = 0;
      ...
      private var m_Threshold:Number = 300.0;
      
      private var m_TimeLeft:Number = 300.0;
      
      private var m_StartTime:Number = 0;
      
      private var m_LastMoveTime:int = 0;
      
      private var m_MoveTime:int = 2.147483647E9;
      
      private var m_MoveMade:Boolean = false;
      
      private var m_HighestLevel:int = 0;
      
      public function BlitzSpeedBonus(app:Blitz3App)
      {
      ...
      public function Update() : void
      {
         ...
         var cId:int = 0;
         var logic:BlitzLogic = this.m_App.logic;
         var matches:Vector.<Match> = logic.frameMatches;
         var isIdle:Boolean = logic.board.IsIdle();
         var numMoves:int = logic.moves.length;
         if(this.m_App.logic.lastHurrahLogic.IsRunning() || this.m_App.logic.IsGameOver())
         {
            this.EndBonus();
            return;
         }
         ...
         {
            value = false;
            value = value || logic.hypercubeLogic.IsHyperMove(this.m_MoveHistory.length);
            this.m_MoveHistory[this.m_MoveHistory.length] = value;
         }
