package com.popcap.flash.framework.resources.images
{
   ...
   public class ImageInst
   {
      ...
      public var mOverridePixels:BitmapData = null;
      
      public var isStarGem:Boolean = false;
      
      public var isFlameGem:Boolean = false;
      ...
      {
         if(this.mOverridePixels != null)
         {
            return this.mOverridePixels;
         }
