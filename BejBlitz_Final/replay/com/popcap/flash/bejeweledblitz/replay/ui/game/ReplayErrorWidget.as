package com.popcap.flash.bejeweledblitz.replay.ui.game
{
   ...
   public class ReplayErrorWidget extends Sprite
   {
      
      protected static const QUERY_PARAMS:Array = new Array("lpt","kt_type","kt_ut","kt_st1","kt_st2");
      ...
      public function ReplayErrorWidget(app:Blitz3App)
      {
         super();
         this.m_App = app;
         buttonMode = true;
         ...
         this.m_QueryString = "";
         this.m_Image = new Bitmap(this.m_App.ImageManager.getBitmapData(Blitz3ReplayImages.IMAGE_REPLAY_ERROR));
         this.m_Image.x = 25;
         this.m_Image.y = 50;
