package com.popcap.flash.bejeweledblitz.game.ui.game.board.gems.effects
{
   ...
   public class FlameGemCreateEffect extends SpriteEffect
   {
      ...
      private var mEvent:FlameGemCreateEvent;
      ...
      public function FlameGemCreateEffect(app:Blitz3App, event:FlameGemCreateEvent)
      {
         super();
         this.m_App = app;
         this.mEvent = event;
      ...
      override public function Update() : void
      {
         ...
         if(percent >= 1)
         {
            this.m_App.SoundManager.playSound(Blitz3GameSounds.SOUND_GEM_FLAME_APPEAR);
            this.mIsDone = true;
            return;
         }
         var gems:Vector.<Gem> = this.mEvent.GetGems();
