package com.popcap.flash.bejeweledblitz.game.ui.gameover.levels
{
   ...
   public class LevelCrestCache
   {
      ...
      protected function LoadCrest(level:Number) : void
      {
         ...
         var url:String = this.m_App.network.GetFlashPath() + "level_crests/" + levelString + ".png";
      ...
      protected function HandleLoadComplete(event:Event) : void
      {
         ...
         var loader:LevelCrestLoader = info.loader as LevelCrestLoader;
         if(loader == null)
         {
