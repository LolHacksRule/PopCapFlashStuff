package com.popcap.flash.bejeweledblitz.game.ui.raregems.phoenixprism
{
   ...
   public class PhoenixFeather extends Sprite
   {
      ...
      public function PhoenixFeather(app:Blitz3App, id:int)
      {
         super();
         this.m_App = app;
         this.m_Id = id + 1;
         this.m_FeatherImage = new Bitmap();
         this.m_CoinLabel = new MediumCoinLabel(app);
      ...
      public function Reset(awarded:Boolean) : void
      {
         this.m_IsAwarded = awarded;
         ...
         this.m_TargetX = 160 + (Math.random() - 0.5) * 160;
         this.m_TargetY = 400;
      ...
      public function SetJackpot(isJackpot:Boolean) : void
      {
         this.m_IsJackpot = isJackpot;
         if(isJackpot)
         {
