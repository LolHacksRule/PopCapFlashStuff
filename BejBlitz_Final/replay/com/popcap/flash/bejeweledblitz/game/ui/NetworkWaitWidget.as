package com.popcap.flash.bejeweledblitz.game.ui
{
   ...
   public class NetworkWaitWidget extends Sprite
   {
      ...
      public function NetworkWaitWidget(app:Blitz3App)
      {
         ...
         this.m_ClickBlock.graphics.drawRect(0,0,this.m_App.uiFactory.GetGameWidth(),this.m_App.uiFactory.GetGameHeight());
         ...
         addChild(panel);
         panel.x = Dimensions.GAME_WIDTH * 0.5 - panel.width * 0.5;
         panel.y = Dimensions.GAME_HEIGHT * 0.5 - panel.height * 0.5;
