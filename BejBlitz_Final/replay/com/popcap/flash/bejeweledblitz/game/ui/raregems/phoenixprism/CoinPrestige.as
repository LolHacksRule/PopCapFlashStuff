package com.popcap.flash.bejeweledblitz.game.ui.raregems.phoenixprism
{
   ...
   public class CoinPrestige extends Sprite
   {
      ...
      public function CoinPrestige(app:Blitz3App, phoenixPrestige:PhoenixPrismPrestige)
      {
         super();
         this.m_App = app;
         this.m_AshPileAndBaby = new Sprite();
         this.m_BabyPhoenix = new BabyPhoenix(app,phoenixPrestige);
         this.m_AshPileTop = new Bitmap();
         this.m_AshPile = new Bitmap();
         this.m_ShareDialog = new CoinPrestigeShareDialog(app,phoenixPrestige);
         this.m_JackpotExplosion = new JackpotExplosion(app);
      }
      ...
      public function Init() : void
      {
         ...
         this.m_ShareDialog.x = -1 + this.m_ShareDialog.width * 0.5;
