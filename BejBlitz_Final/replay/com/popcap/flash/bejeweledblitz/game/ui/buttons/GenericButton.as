package com.popcap.flash.bejeweledblitz.game.ui.buttons
{
   ...
   public class GenericButton extends ResizableButton
   {
      ...
      public function GenericButton(app:Blitz3App, fontSize:int = 14, eventId:String = null, trackId:String = null)
      {
         super(app,Blitz3GameFonts.FONT_BLITZ_STANDARD,fontSize,eventId,trackId);
         var buttonCap:Bitmap = new Bitmap(m_App.ImageManager.getBitmapData(Blitz3GameImages.IMAGE_PINK_BUTTON_CAP));
         ...
         slices[1][1] = new Bitmap(m_App.ImageManager.getBitmapData(Blitz3GameImages.IMAGE_PINK_BUTTON_FILL));
