package com.popcap.flash.bejeweledblitz.game.ui.dialogs
{
   ...
   public class SingleButtonDialog extends Sprite
   {
      ...
      public function SingleButtonDialog(param1:Blitz3App, param2:int = 18)
      {
         super();
         this.m_App = param1;
         ...
         this.m_ButtonContinue = new GenericButtonFramed(this.m_App,param2);
      }
