package com.popcap.flash.bejeweledblitz.game.ui.buttons
{
   ...
   public class DeclineButton extends ResizableButton
   {
      ...
      public function DeclineButton(param1:Blitz3App, param2:int = 14, param3:String = null, param4:String = null)
      {
         super(param1,Blitz3GameFonts.FONT_BLITZ_STANDARD,param2,param3,param4);
         var _loc5_:Bitmap = new Bitmap(_app.ImageManager.getBitmapData(Blitz3GameImages.IMAGE_RED_BUTTON_CAP));
         ...
         _loc8_[1][0] = _loc5_;
         _loc8_[1][1] = new Bitmap(_app.ImageManager.getBitmapData(Blitz3GameImages.IMAGE_RED_BUTTON_FILL));
