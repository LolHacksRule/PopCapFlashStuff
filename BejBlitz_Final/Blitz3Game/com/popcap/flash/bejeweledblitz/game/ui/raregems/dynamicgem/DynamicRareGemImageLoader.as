package com.popcap.flash.bejeweledblitz.game.ui.raregems.dynamicgem
{
   ...
   public class DynamicRareGemImageLoader
   {
      ...
      public function DynamicRareGemImageLoader(param1:Blitz3App)
      {
         super();
         this._app = param1;
      }
      ...
      {
         var _loc2_:String = ServerURLResolver.resolveUrl(this._app.network.GetDLCPath() + "images/gemicons/" + param1 + "_2x.png");
         var _loc3_:String = this._app.network.GetMediaPath() + _loc2_;
         AssetLoader.load([DynamicRareGemParser.RARE_GEM_IMAGE_LOADING_PREFIX + param1],_loc3_);
      }
      ...
      {
         return AssetLoader.getSpecificPercentLoaded(DynamicRareGemParser.RARE_GEM_IMAGE_LOADING_PREFIX + param1);
      }
      ...
      {
         return AssetLoader.isAssetLoaded(DynamicRareGemParser.RARE_GEM_IMAGE_LOADING_PREFIX + param1);
      }
