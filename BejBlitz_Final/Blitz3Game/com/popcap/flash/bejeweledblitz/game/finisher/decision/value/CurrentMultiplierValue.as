package com.popcap.flash.bejeweledblitz.game.finisher.decision.value
{
   ...
   public class CurrentMultiplierValue extends ValueType
   {
       
      
      public function CurrentMultiplierValue()
      {
         super();
      }
      ...
      {
         return new NumberDataType(DecisionHelper.Get().GetCurrentMultiplier());
      }
   }
}
