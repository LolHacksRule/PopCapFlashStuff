package com.popcap.flash.bejeweledblitz.game.finisher.decision.value
{
   ...
   public class LeaderboardScoreValue extends ValueType
   {
       
      
      public function LeaderboardScoreValue()
      {
         super();
      }
      ...
      {
         return new NumberDataType(DecisionHelper.Get().GetCurrentLeaderboardScore());
      }
   }
}
