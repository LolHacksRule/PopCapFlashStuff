package com.popcap.flash.bejeweledblitz.logic.finisher.picker
{
   ...
   public class CustomGemPickerRtoL implements IGemPicker
   {
      ...
      public function CustomGemPickerRtoL(param1:BlitzLogic)
      {
         super();
         this._logic = param1;
      ...
      public function PostAddingPattern() : void
      {
         this.PickNonZeroRow();
         this.PickNonZeroCol();
         this.currCol = this.nonZeroCols.length - 1;
         this.currRow = 0;
      }
