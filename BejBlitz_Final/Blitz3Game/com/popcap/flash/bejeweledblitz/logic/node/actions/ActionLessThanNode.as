package com.popcap.flash.bejeweledblitz.logic.node.actions
{
   ...
   public class ActionLessThanNode extends ActionNode
   {
       
      
      public function ActionLessThanNode(param1:BlitzLogic)
      {
         super();
      ...
      override public function DoAction() : ParameterNode
      {
         ...
         var _loc7_:Boolean;
         if(_loc7_ = _loc5_.LessThan(_loc6_))
         {
            if(_loc3_ != null)
            {
