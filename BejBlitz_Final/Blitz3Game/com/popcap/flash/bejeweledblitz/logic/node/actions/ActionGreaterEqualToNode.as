package com.popcap.flash.bejeweledblitz.logic.node.actions
{
   ...
   public class ActionGreaterEqualToNode extends ActionNode
   {
       
      
      public function ActionGreaterEqualToNode(param1:BlitzLogic)
      {
         super();
      ...
      override public function DoAction() : ParameterNode
      {
         ...
         var _loc7_:Boolean;
         if(_loc7_ = _loc5_.GreaterThan(_loc6_) || _loc5_.IsEqual(_loc6_))
         {
            if(_loc3_ != null)
            {
