package com.popcap.flash.bejeweledblitz.logic.node.actions
{
   ...
   public class ActionDecrementByNode extends ActionNode
   {
       
      
      public function ActionDecrementByNode(param1:BlitzLogic)
      {
         super();
