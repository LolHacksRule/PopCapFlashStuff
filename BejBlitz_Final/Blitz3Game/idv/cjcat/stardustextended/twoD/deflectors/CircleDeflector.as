package idv.cjcat.stardustextended.twoD.deflectors
{
   ...
   public class CircleDeflector extends Deflector
   {
      ...
      public function CircleDeflector(param1:Number = 0, param2:Number = 0, param3:Number = 100)
      {
         super();
         this.x = param1;
         this.y = param2;
      ...
      override protected function calculateMotionData4D(param1:Particle2D) : MotionData4D
      {
         ...
         return MotionData4DPool.get(this.x + this.r.x,this.y + this.r.y,param1.vx - this.v.x * this.factor,param1.vy - this.v.y * this.factor);
      }
