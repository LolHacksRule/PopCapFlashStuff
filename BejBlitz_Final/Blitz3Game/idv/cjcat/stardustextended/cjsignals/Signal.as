package idv.cjcat.stardustextended.cjsignals
{
   ...
   public class Signal implements ISignal
   {
      ...
      public final function dispatch(... rest) : Signal
      {
         ...
         while(_loc2_ < _loc3_)
         {
            if(!(rest[_loc2_] is this._valueClasses[_loc2_] || rest[_loc2_] == null))
            {
         ...
         {
            (_loc4_ = this._currentListenerArray[_loc2_]).listener.apply(null,rest);
            if(_loc4_.once)
            {
