   ...
   public class Zip extends EventDispatcher implements IZip
   {
      ...
      public function serialize(param1:IDataOutput, param2:Boolean = false) : void
      {
         ...
         if(param1 != null && this.filesList.length > 0)
         {
            ...
            {
               if((_loc8_ = this.filesList[_loc7_] as ZipFile) != null)
               {
      ...
      public function getFileAt(param1:uint) : IZipFile
      {
         return !!this.filesList ? this.filesList[param1] as IZipFile : null;
      }
      
      public function getFileByName(param1:String) : IZipFile
      {
         return !!this.filesDict[param1] ? this.filesDict[param1] as IZipFile : null;
      }
      
      public function addFile(param1:String, param2:ByteArray = null, param3:Boolean = true) : ZipFile
      {
         return this.addFileAt(!!this.filesList ? uint(this.filesList.length) : uint(0),param1,param2,param3);
      }
      
      public function addFileFromString(param1:String, param2:String, param3:String = "utf-8", param4:Boolean = true) : ZipFile
      {
         return this.addFileFromStringAt(!!this.filesList ? uint(this.filesList.length) : uint(0),param1,param2,param3,param4);
      }
      ...
      public function addFileAt(param1:uint, param2:String, param3:ByteArray = null, param4:Boolean = true) : ZipFile
      {
         ...
         var _loc5_:ZipFile;
         (_loc5_ = new ZipFile()).filename = param2;
      ...
      public function addFileFromStringAt(param1:uint, param2:String, param3:String, param4:String = "utf-8", param5:Boolean = true) : ZipFile
      {
         ...
         var _loc6_:ZipFile;
         (_loc6_ = new ZipFile()).filename = param2;
      ...
      public function removeFileAt(param1:uint) : IZipFile
      {
         var _loc2_:IZipFile = null;
         if(this.filesList != null && this.filesDict != null && param1 < this.filesList.length)
         {
            _loc2_ = this.filesList[param1] as IZipFile;
            if(_loc2_ != null)
            {
