package com.popcap.flash.bejeweledblitz.game.finisher.decision.value
{
   ...
   public class Currency3BalanceValue extends ValueType
   {
       
      
      public function Currency3BalanceValue()
      {
         super();
      }
      ...
      {
         return new NumberDataType(DecisionHelper.Get().GetCurrency3Balance());
      }
   }
}
