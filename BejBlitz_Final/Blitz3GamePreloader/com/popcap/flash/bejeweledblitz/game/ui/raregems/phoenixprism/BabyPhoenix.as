package com.popcap.flash.bejeweledblitz.game.ui.raregems.phoenixprism
{
   ...
   public class BabyPhoenix extends Sprite
   {
      ...
      public function BabyPhoenix(param1:Blitz3App, param2:PhoenixPrismPrestige)
      {
         super();
         this.m_App = param1;
      ...
      private function CatchFeather(param1:PhoenixFeather) : void
      {
         if(param1 == null)
         {
            return;
         ...
         addChildAt(param1,3);
         param1.rotation = 0;
         param1.x = this.m_BeakOpen.x + this.m_BeakOpen.width * 0.75;
         param1.y = this.m_BeakOpen.y + this.m_BeakOpen.height * 0.5 + 8;
      }
      
      private function AwardCoins(param1:PhoenixFeather) : void
      {
         if(!this.m_App.logic.mIsReplay)
         {
            this.m_App.logic.coinTokenLogic.SpawnCoinForBonus(param1.GetValue());
         }
      }
   }
}
