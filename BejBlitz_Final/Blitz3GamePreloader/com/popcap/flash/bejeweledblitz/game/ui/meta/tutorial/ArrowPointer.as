package com.popcap.flash.bejeweledblitz.game.ui.meta.tutorial
{
   ...
   public class ArrowPointer extends Sprite
   {
      ...
      public function ArrowPointer(param1:Blitz3App)
      {
         super();
         this.m_App = param1;
         ...
         var _loc2_:Number = 0.5 * GemSprite.GEM_SIZE;
         this.m_Curve.setInRange(0,PERIOD);
         this.m_Curve.setOutRange(_loc2_,_loc2_);
         this.m_Curve.addPoint(0.5 * PERIOD,_loc2_ + DISTANCE_PERCENT * this.m_Arrow.width);
      }
