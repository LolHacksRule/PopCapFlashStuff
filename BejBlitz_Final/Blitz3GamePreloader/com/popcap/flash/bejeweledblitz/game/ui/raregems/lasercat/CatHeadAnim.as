package com.popcap.flash.bejeweledblitz.game.ui.raregems.lasercat
{
   ...
   public class CatHeadAnim extends AnimatedSprite
   {
      ...
      
      {
         ...
         ANIM_DATA_OUTRO.push(new KeyframeData(ANIM_TICKS_OUTRO,KeyframeData.IGNORE_VALUE,-240.5,1,1));
      }
      ...
      public function CatHeadAnim(param1:Blitz3App)
      {
         super();
         this.m_App = param1;
      ...
      {
         var _loc1_:LaserCatEye = null;
         if(Constants.IS_HALLOWEEN || Constants.IS_THANKSGIVING || Constants.IS_CHRISTMAS)
         {
            this.m_CatHead.bitmapData = this.m_App.ImageManager.getBitmapData(Blitz3GameImages.IMAGE_LASER_CAT_HEAD_SEASONAL);
            this.m_CatHead.x = -135 * 0.5 - (155 - 135) * 0.5;
            this.m_CatHead.y = -112 * 0.5 - (157 - 112);
         }
         else
         {
         ...
         this.CreateEyes();
         this.CreateAnims();
         for each(_loc1_ in this.m_Eyes)
         {
            _loc1_.Init();
         }
         this.Reset();
      ...
      override public function Update() : void
      {
         ...
         for each(_loc2_ in this.m_Eyes)
         {
            _loc2_.Update();
      ...
      protected function CreateEyes() : void
      {
         ...
         for each(_loc1_ in this.m_LaserSources)
         {
            _loc2_ = new LaserCatEye(this.m_App);
            _loc2_.x = _loc1_.x;
            _loc2_.y = _loc1_.y;
            addChild(_loc2_);
            this.m_Eyes.push(_loc2_);
         }
      }
