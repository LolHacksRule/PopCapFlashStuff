package com.popcap.flash.bejeweledblitz.game.ui.game.board.gems.effects
{
   ...
   public class HyperGemCreateEffect extends SpriteEffect
   {
       
      
      private var m_App:Blitz3App;
      
      private var mEvent:HypercubeCreateEvent;
      ...
      public function HyperGemCreateEffect(param1:Blitz3App, param2:HypercubeCreateEvent)
      {
         super();
         this.m_App = param1;
         this.mEvent = param2;
      ...
      override public function Update() : void
      {
         ...
         if(_loc1_ >= 1)
         {
            this.m_App.SoundManager.playSound(Blitz3GameSounds.SOUND_GEM_HYPERCUBE_APPEAR);
            this.mIsDone = true;
            return;
         }
