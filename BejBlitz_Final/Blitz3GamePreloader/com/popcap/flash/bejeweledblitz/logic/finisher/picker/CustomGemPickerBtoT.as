package com.popcap.flash.bejeweledblitz.logic.finisher.picker
{
   ...
   public class CustomGemPickerBtoT implements IGemPicker
   {
      ...
      public function CustomGemPickerBtoT(param1:BlitzLogic)
      {
         super();
         this._logic = param1;
      ...
      public function PostAddingPattern() : void
      {
         ...
         this.PickNonZeroCol();
         this.currCol = 0;
         this.currRow = this.nonZeroRows.length - 1;
      }
      ...
      public function GetGem() : Gem
      {
         var _loc2_:int = 0;
         var _loc1_:int = 0;
         while(this.currRow >= 0)
         {
            _loc1_ = this.nonZeroRows[this.currRow];
            _loc2_ = this.currCol;
            while(_loc2_ < this.pattern[0].length)
            {
               if(this.pattern[_loc1_][_loc2_] != "0")
               {
                  this.currCol = _loc2_ + 1;
                  return this._logic.board.GetGemAt(_loc1_,_loc2_);
               }
               _loc2_++;
            }
