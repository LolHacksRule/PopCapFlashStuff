package com.popcap.flash.bejeweledblitz.logic.gems.hypercube
{
   ...
   public class HypercubeCreateEvent implements IBlitzEvent
   {
      ...
      public function HypercubeCreateEvent(param1:BlitzLogic)
      {
         super();
         this._logic = param1;
      ...
      {
         return this._time / this._logic.config.hypercubeCreateEventDuration;
      }
      ...
      public function Update(param1:Number) : void
      {
         ...
         this._time += param1;
         if(this._time >= this._logic.config.hypercubeCreateEventDuration)
         {
            this._time = this._logic.config.hypercubeCreateEventDuration;
            this._isDone = true;
            this.OnDone();
         }
      }
