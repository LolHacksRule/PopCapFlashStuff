package com.popcap.flash.bejeweledblitz.logic.node.actions
{
   ...
   public class ActionRandomIntNode extends ActionNode
   {
       
      
      public function ActionRandomIntNode(param1:BlitzLogic)
      {
         super();
      ...
      override public function DoAction() : ParameterNode
      {
         ...
         {
            return new NumberDataTypeNode(_loc1_.Int(0,1));
         }
         ...
         return new NumberDataTypeNode(_loc1_.Int(_loc6_.dataValue,_loc7_.dataValue));
      }
   }
}
