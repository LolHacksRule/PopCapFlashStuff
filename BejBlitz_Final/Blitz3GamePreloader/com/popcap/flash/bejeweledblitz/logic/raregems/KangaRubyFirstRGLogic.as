package com.popcap.flash.bejeweledblitz.logic.raregems
{
   ...
   public class KangaRubyFirstRGLogic extends KangaRubyRGLogic
   {
      
      public static const ID:String = "kangaRuby";
      ...
      private static const _BOARD3:String = "WRYRRYRWRWGOOGWRYGWRRWGYRORWWRORRORWWRORYGWRRWGYRWGOOGWRWRYRRYRW";
      
      private static const _BOARD4:String = "YPYPYPYPROROROROYRYRYRYRROROROROPYPYPYPYROROROROYRYRYRYRRPRPRPRP";
      
      private static const _BOARD5:String = "RBRBRBRBYRYRYRYRROROROROWPGBBGPWROROROROYRYRYRYRROROROROWPGBBGPW";
       
      
      public function KangaRubyFirstRGLogic(param1:BlitzLogic)
      {
         super();
         ...
         _boardPatterns.parseBoardString(_BOARD4);
         _boardPatterns.parseBoardString(_BOARD5);
         _state = STATE_INACTIVE;
         _kangaRubyAttackPatterns = new KangaRubyAttackPatternsFirst();
