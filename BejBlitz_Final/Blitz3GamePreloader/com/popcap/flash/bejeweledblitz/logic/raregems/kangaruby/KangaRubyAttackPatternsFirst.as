package com.popcap.flash.bejeweledblitz.logic.raregems.kangaruby
{
   ...
   public class KangaRubyAttackPatternsFirst extends KangaRubyAttackPatterns
   {
      
      public static const NUM_PRESTIGE_HITS:int = 10;
       
      
      public function KangaRubyAttackPatternsFirst()
      {
         super();
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         ...
         _prestigeExplosionPattern[0][0][1] = true;
         _prestigeExplosionPattern[0][1][1] = true;
         _prestigeExplosionPattern[0][2][1] = true;
         _prestigeExplosionPattern[0][3][1] = true;
         _prestigeExplosionPattern[0][4][1] = true;
         _prestigeExplosionPattern[0][5][1] = true;
         _prestigeExplosionPattern[0][6][1] = true;
         _prestigeExplosionPattern[0][7][1] = true;
         _prestigeExplosionPattern[1][0][0] = true;
         _prestigeExplosionPattern[1][1][0] = true;
         _prestigeExplosionPattern[1][2][0] = true;
         _prestigeExplosionPattern[1][3][0] = true;
         _prestigeExplosionPattern[2][4][4] = true;
         _prestigeExplosionPattern[3][3][3] = true;
         _prestigeExplosionPattern[4][4][3] = true;
         _prestigeExplosionPattern[5][3][2] = true;
         _prestigeExplosionPattern[6][4][2] = true;
         _prestigeExplosionPattern[7][1][2] = true;
         _prestigeExplosionPattern[7][2][2] = true;
         _prestigeExplosionPattern[7][3][2] = true;
         _prestigeExplosionPattern[8][1][3] = true;
         _prestigeExplosionPattern[8][2][3] = true;
         _prestigeExplosionPattern[8][3][3] = true;
         _prestigeExplosionPattern[9][5][3] = true;
         _prestigeExplosionPattern[9][5][4] = true;
         _prestigeExplosionPattern[9][5][5] = true;
         _prestigeExplosionPattern[9][5][6] = true;
         _prestigeExplosionPattern[9][6][3] = true;
         _prestigeExplosionPattern[9][6][4] = true;
         _prestigeExplosionPattern[9][6][5] = true;
         _prestigeExplosionPattern[9][6][6] = true;
      }
   }
}
